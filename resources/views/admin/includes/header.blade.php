...
<head>
    ...
    <link rel="stylesheet" href="{{Vite::asset('public/dist/css/adminlte.css')}}">
...
<nav class="app-header navbar navbar-expand bg-body"> <!--begin::Container-->
    <div class="container-fluid"> <!--begin::Start Navbar Links-->
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-md-block"><a href="{{route('admin.main')}}"
                                                      class="nav-link">Домой</a></li>
        ...
        <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
                    ...
                    <a href="#" class="dropdown-item"> <!--begin::Message-->
                        <div class="d-flex">
                            <div class="flex-shrink-0"><img
                                    src="{{Vite::asset('public/dist/assets/img/user8-128x128.jpg')}}"
                                    alt="User Avatar"
                                    class="img-size-50 rounded-circle me-3"></div>
                            <div class="flex-grow-1">
                                <h3 class="dropdown-item-title">
            ...
            <li class="nav-item d-none d-md-block"><a href="{{route('home')}}"
                                                      class="nav-link">Выйти</a></li><!--end::Fullscreen Toggle-->
