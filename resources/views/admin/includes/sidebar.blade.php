...
<div class="app-wrapper">
    <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark"> <!--begin::Sidebar Brand-->
        <div class="sidebar-brand"> <!--begin::Brand Link--> <a href="{{route('admin.main')}}" class="brand-link">
                <!--begin::Brand Image--> <img
                    src="{{Vite::asset('public/dist/assets/img/AdminLTELogo.png')}}" alt="AdminLTE Logo"
        ...
        <div class="sidebar-wrapper">
            <nav class="mt-2"> <!--begin::Sidebar Menu-->
                <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item"><a href={{route('admin.books.index') }} class="nav-link"> <i
